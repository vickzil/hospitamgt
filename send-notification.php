...
<head>
        <?php $GLOBALS['title'] = "Send Notifications | PHP Hospital"; require 'components/head.php'; ?>
        <!-- Summernote css -->
                        ...
                        <div class="col-md-12">
                            <nav aria-label="breadcrumb" class="float-right mt-1">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Sent Notifications</li>
                                </ol>
                            </nav>
                            <h4 class="mb-1 mt-0">Sent Notifications</h4>
                        </div>
                    </div>
                        ...
                        <div class="col-md-3 card">
                            ...
                            <div class="mail-list mt-4">
                             ...
                             <?php
                                ...
                                <a href="send-notification" class="list-group-item border-0 text-danger font-weight-bold"><i
                        ...
                        <div class="col-md-9 col-sm-12">
                            <div class="email-container ">
                                ...
                                <ul class="message-list">
                                    ...
                                    $querySent="SELECT * from comments WHERE user_sent_id='$userEmail' ORDER BY comment_date DESC";
                                    $resultSent=mysqli_query($con,$querySent);

                                    $NotificationSent = mysqli_num_rows($resultSent);


                                     if($NotificationSent > 0) {

                                    while($rowSent=mysqli_fetch_array($resultSent)) :  ?>

                                    <li class="unread">
                                        <div class="col-mail col-mail-1">
                                            <span class="star-toggle uil uil-star"></span>
                                            <a href="sent-notification?sent=<?php echo $rowSent['comment_id']; ?>" class="title">To <?php echo $rowSent['user_id']; ?></a>
                                        </div>
                                        <div class="col-mail col-mail-2" style="overflow: hidden;">
                                            <a href="sent-notification?sent=<?php echo $rowSent['comment_id']; ?>" class="subject"> 
                                                <?php echo excerpt($rowSent['comment_subject'], 0, '50'); ?>
                                            </a>
                                            <div class="date" id="date"><?php echo date('M d Y H:ia', strtotime($rowSent['comment_date'])); ?></div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="unread">
                                        <div class="text-center">No Sent Messages</div>
                                    </li>
