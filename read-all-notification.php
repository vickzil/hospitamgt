...
<head>
        <?php $GLOBALS['title'] = "Read all Notifications | PHP Hospital"; require 'components/head.php'; ?>
                                        ...
                                        <div class="media mb-4 mt-1">
                                          ...
                                          <?php } ?>
                                            ...
                                            <div class="media-body">
                                                ...
                                                <h6 class="m-0 font-13" style="font-size: 13px;"><b>To:</b> <?php echo $extractUser['user_id']; ?></h6>
