                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="email-container bg-transparent">
                                    <div class="mt-2">
                                        <h5 class="mt-3 mb-4 font-size-16 font-weight-bold ml-2">Inbox Notifications</h5>
                            ...
                            <div class="email-container bg-transparent mt-5">

                                    <div class="mt-4">
                                        <h5 class="mt-5 mb-4 font-size-16 font-weight-bold ml-2">Sent Notifications</h5>
                                        <ul class="message-list">
                                            ...
                                            $query="SELECT * from comments WHERE user_sent_id='$userEmail' ORDER BY comment_date DESC";
