    ...
    <body  class="<?php echo $userTheme; ?>" data-left-keep-condensed="true">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-md-12">
                                <nav aria-label="breadcrumb" class="float-right mt-1">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Doctor's Details</li>
                                    </ol>
                                </nav>
                                <h4 class="mb-1 mt-0"> Doctor's Details</h4>
                            </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="card mt-5">
                              <div class="card-body">
                                <h4 class="h4 mt-0 mb-4 text-info" id="text-logo">Doctor's Data Table</h4>
                                <div class="table-responsive">
                                  <table id="basic-datatable" class="table dt-responsive nowrap">
                                    ...
                                    <tbody class="text-center">
                                      ...
                                      // Get Doctors Details from Appointment table and display
                        ...
                        <div class="row">
                          <div class="col-12">
                            <div class="card">
                              <div class="card-body">
                                <h4 class="h4 mt-0 mb-4 text-info" id="text-logo">Edit/Delete Doctor's Data Table</h4>
                                <div class="table-responsive">
                                  <table id="basic-datatable" class="table dt-responsive nowrap">
                                    <thead>
                                      <tr>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td style="display: none;"><?php echo $row['availability']; ?></td>
                                        <td><?php echo $row['specialty']; ?></td>
                                        <td style="display: none;"><?php echo $row['days']; ?></td>
                                        <td style="display: none;"><?php echo $row['datecreated']; ?></td>
                                        <td colspan="2" class="text-center">
                                          <button class="text-success btn btn-outline-light mr-1 editdoc">
                                          <i class="fa fa-pencil-square-o"></i>
                                          </button>

                                          <button type="button" class="text-danger btn btn-outline-light deletedoc">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header py-3 px-4 border-bottom-0 d-block bg-dark">
                          ...
                          <h5 class="modal-title text-light" id="modal-title">Doctor's Details</h5>
                      </div>
                        ...
                        <form action="doctor.inc.php" method="POST" class="needs-validation" name="event-form" id="form-event" novalidate>
                          ...
                          <div class="row">
                            <div class="col-md-4 form-group mb-4 ">
                              <label class="form-label">Specialty <span class="form-required text-danger">*</span></label>
                              <select id="specialty" name="specialty" class="form-control">
                                <?php display_specialty(); ?>
                              </select>
                            </div>
                            <div class="col-md-4 form-group mb-4">
                              <label class="form-label">Avaliability <span class="form-required text-danger">*</span></label>
                            ...
                            <div class="col-md-4 form-group mb-4">
                              <label class="form-label">Work Days <span class="form-required text-danger">*</span></label>
                          ...
                          <div class="col-md-12 form-group">
                            <input type="submit" name="updateDoc" value="Update Doctor" class="btn btn-dark btn-block">
                          </div>   
                        </form>
                      </div>
                ...
                <!-- Delete Doctor MODAL -->
                <div class="modal fade" id="deletedoc-modal" tabindex="-1">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header py-3 px-4 border-bottom-0 d-block bg-dark">
                          <button type="button" class="close text-light" data-dismiss="modal"
                          aria-hidden="true">&times;</button>
                          <h5 class="modal-title text-light" id="modal-title">Delete Doctor</h5>
                      </div>
                      <div class="modal-body p-4">
                        <form action="doctor.inc.php" method="POST" class="needs-validation" name="event-form" id="form-event" novalidate>
                          ...
                          <div class="form-group mt-4">
                            <button type="submit" name="deletedoc" class="btn mr-1 text-light bg-dark" >Yes</button>
