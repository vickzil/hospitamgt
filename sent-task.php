...
<head>
        <?php $GLOBALS['title'] = "Asigned Tasks | PHP Hospital"; require 'components/head.php'; ?>
                    ...
                    <div class="container-fluid">
                        <div class="row page-title align-items-center">
                            <div class="col-md-3 col-xl-6">
                                <h4 class="mb-1 mt-0">Todo Task</h4>
                            </div>
                        ...
                        <div class="row">
                            ...
                            $queryTask="SELECT * FROM tasks WHERE task_assignto !='$userFullname' AND postedby='$userFullname' ORDER BY task_date DESC";
